...
Dans la a mise en œuvre, par exemple dans un travail scientifique, les
...
## Analyse des réponses au questionnaire, 1ère partie
...
reponses_socio %>% 
  ...
  filter(note_ecole > 3.99,
         note_uni > 0.99) %>% 
  summarize(note_ecole_moyenne = mean(note_ecole),
