...
Voici l'histogramme des points obtenus par n = 79 étudiant.es qui ont
...
-   63 étudiant.es (79.7%) ont réussi Problem Set 3.
...
**Sujet : La statistique déscriptive**
...
# Session 11 (cours en auto-apprentissage)

**Sujet : La statistique inférentielle, Partie 1 (t-test)**

Dans cette leçon, nous allons nous concentrer sur trois méthodes de
statistiques inférentielles couramment utilisées :
...
Si les graphiques de diagnostic montrent que les hypothèses ne sont pas satisfaites, cela peut indiquer que le
modèle n'est pas adéquat et qu'une transformation des données ou une
sélection de variables différente peut être nécessaire.

Dans le cas spécifique du modèle de régression `modele_1`, qui modélise `mpg ~ wt` dans le jeu de données `mtcars`, les graphique de diagnostic sont tout à fait acceptable.
...
### Ressources pour aller plus loin (pas pertinent pour le Problem Set 4)
