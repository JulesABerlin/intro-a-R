...
Voici l'histogramme des points obtenus par n = 79 étudiant-e-s qui ont
participé au Problem Set 3.
...
points_ps_3 <- read.csv("~/Documents/GitHub/intro-a-R/code/points_ps_3_v2.csv", encoding="UTF-8")

#points_ps_3 # il y a 79 observations

hist_ps_3 <-ggplot(points_ps_3, 
                   aes(x=x)) + 
  geom_histogram(binwidth = 1, color="black", fill="white") +
  labs(title = "Histogramme des points obtenus dans le PS 3 (Corrigé !)", # labs() permet de définir plusieurs labels en même temps (titre, axes, etc.)
       subtitle = "n = 79 résultats de test", 
       caption = "Source des données : Moodle") +       
  xlab("Points obtenus") +                             
  ylab("Fréquence") + 
  theme_minimal() +
...
-   La fréquence de chaque catégories (p. ex. combien de participants à
...
-   des **tableaux** pour les mesures telles que la taille de
    ...
    catégories, p. ex. homme et femme.
...
codes R nécessaires pour dans ce cours.
...
Vous pouvez ensuite télécharger le fichier `reponses_socio.csv`depuis la
page Moodle du cours (matériel de la 10ème session) et le sauvegarder
