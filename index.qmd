...
```{r}
# Générer des données d'échantillon avec n = 25 observations hypothétiques de QI d'étudiant-e.
# Nous simulons, avec rnorm() 25 observations d'une loi normale avec une moyenne de 25 et un écart-type de 15
set.seed(123)
