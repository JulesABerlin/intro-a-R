...
linéaire et vérifier si les hypothèses du modèle sont satisfaites (p. ex. si les variables suivent approximativement une loi normale). En
...
Explications des quatre graphiques diagnostiques : (**SOUS CONSTRUCTION**)
...
utile de vérifier les graphiques des résidus pour valider les
