...
dans RStudio à partir de **fichier CSV** et de les stocker en forme de data frame (format tabulaire).
...
Avant l'imporation de fichier CSV dans RStudio (et comme déjà vu pleins
...
devez effacer le dièze et adapter le code suivant pour qu'il marche sur
votre ordinateur) :
...
4.  Une fenêtre avec des paramètre apparait, que vous pouvez remplir de
    ...
    -   Explications des paramètres :
        ...
        -   **Encoding = UTF-8** : Indique à RStudio d'utiliser
            l'encodage de caractères UTF-8, ce qui est important pour
            lire correctement toutes les lettres (p. ex. é, ä, ê, etc.).
...
-   Assurez-vous d'avoir **rempli le questionnaire avant la date
    limite** (**19 avril 2024 à 23h59**). Tous les étudiant(e)s qui
