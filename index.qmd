...
-   La moyenne des points obtenus était de 11.5 (note = 4.25).

-   59 étudiant.es (75%) ont réussi Problem Set 3.
...
hist_ps_3 <-ggplot(points_ps_3, 
                   aes(x=x)) + 
  geom_histogram(binwidth = 1, color="black", fill="white") +
  labs(title = "Histogramme des points obtenus dans le PS 3", # labs() permet de définir plusieurs labels en même temps (titre, axes, etc.)
