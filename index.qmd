...
d'analyser des **relations de cause à effet** (c'est en effet le rôle de
la *statistique inférentielle*).

Les mesures suivantes font souvent partie des statistiques d

-   La taille de l'échantillon (nombre d'observations n)

-   Les mesures de tendance centrale (moyenne, médiane, mode)

-   Les mesures de dispersion (variances, kurtosis, etc.

-   Identification des valeurs extrêmes (également appelées valeurs
    aberrantes) de variables numériques.

-   Répartition en pourcentage des variables catégorielles
    (identification de la fréquence de chaque catégorie)

échantillon ou d'une population en utilisant des mesures de tendance
centrale (moyenne, médiane, mode), de dispersion (étendue, variance,
écart-type) et de position (percentiles, quartiles). Elle inclut
également l'utilisation de graphiques et de tableaux pour représenter
visuellement les données. La statistique descriptive est une étape
importante dans l'analyse de données quantitatives, car elle permet de
décrire les données de manière claire et concise, facilitant ainsi leur
interprétation.
