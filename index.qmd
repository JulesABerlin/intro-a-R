...
Les résultats du **Problem Set 1** (bonnes réponses, échelle des notes) sont accéssibles sur la page Moodle
de l'exercices.

Voici l'histogramme des points obtenus par n = 81 étudiant.es qui ont participé au Problem Set 1. Le nombre maximal de points était de 20, il fallait 10 pour passer le test.
...
Il y a des statistiques sur trois espèces d'iris dans le jeu de données  [Source :
