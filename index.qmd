...
### 20 : write.csv() (pas pertinent pour Problem Set 3)
...
Dans la a mise en œuvre d'une analyse statistique, par exemple dans un travail scientifique, les
statistiques descriptives sont souvent présentées sous deux formats :
...
Veuillez ouvrir un nouveau script R et charger les paquets `tidyverse` et `ggthemes`. Ensuite, vous pouvez définir votre répértoire de travaille.
...
reponses_socio.csv](images/Screenshot 2024-05-01 at 09.09.22.png)
